...
/// </summary>
[Serializable]
public class MightyXorSettings
{
    ...
    /// <summary>
    /// Determines if MightyXOR should include the file header
    /// specified in the class <see cref="MightyXorFileHeader"/>
    ...
    /// If it is, the MD5 hash <see cref="MightyXorFileHeader.Md5Hash">specified in the header</see>
    /// is compared with the actual hash of the <see cref="MightyXorFile.Content">file content</see>.
