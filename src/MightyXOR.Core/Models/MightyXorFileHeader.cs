using MightyXOR.Common.Serialization.Converters;
...
public class MightyXorFileHeader
{
    ...
    public MightyXorFileHeader(FileInfo fileInfo, byte[] md5Hash)
    {
        Name = fileInfo.Name;
    ...
    protected bool Equals(MightyXorFileHeader other)
    {
    ...
    public override bool Equals(object? obj)
    {
        ...
        return Equals((MightyXorFileHeader)obj);
    }
